...
public class BrowserUtils {
    ...
    /*
     * takes screenshot
     * // whenever you call this method it takes screenshots and returns a path to screenshots takes
     * @param name
...
//        String date = LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm"));​
        ...
        // if it doesn't take  screenshots in any way, remove date and time part
